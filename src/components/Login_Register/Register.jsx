...
{/*     
        ...
        <div class="flex items-center border-2 py-2 px-3 rounded-xl mb-4">
          ...
          <input onChange={(e) =>{setUserName(e.target.value)}} class="pl-2 outline-none border-none bg-transparent text-white text-[14px]" type="text" name="" id="" placeholder="Username" />
        </div>
