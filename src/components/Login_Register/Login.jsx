...
const handleSubmit = async(e) =>{
  ...
  return (
    ...
    <div className='flex items-center justify-center w-full min-h-screen'>
      ...
      <div className='w-[400px] h-[400px] backdrop-blur-md bg-white/10 rounded-md items-center justify-center flex relative'>
      ...
      { logFail && <div>
        ...
        <h3 className='p-2 text-sm text-center text-red-700 border-2 rounded-md border-bethel-green'>Invalid Email or Password</h3>
      </div> }
    ...
    {/* <div class="flex flex-col items-center w-full justifyl-center h-[400px] rounded-b-xl  absolute bg-white top-0">
